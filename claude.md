...
│   ├── projects/      # Project management, 3+1 constraint logic
│   ├── tasks/         # Task CRUD, scheduling
│   ├── goals/         # Annual goals (minimal in Phase 1)
│   └── reflection/    # Weekly reflection (basic in Phase 1)
├── pages/             # Main views
│   ├── WeeklyPlanningView.tsx  # Primary workspace (3-panel)
│   ├── GoalsProjectsView.tsx   # Strategic overview
...
- Minimal in Phase 1, enhanced in Phase 2
...
5. **Animations**: Staggered reveals work smoothly
6. **Responsive**: Works on desktop (1200px+) and tablet (768px+)
